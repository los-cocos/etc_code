...
from cocos.tiles import TmxObjectMapCollider
...
def main():
    ...
    fn_collision_handler = tiles.make_collision_handler(
        TmxObjectMapCollider('bounce'), #  change to 'stick' for sticky grenade behavior
        walls)
